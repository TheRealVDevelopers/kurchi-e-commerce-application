            ...
            <TabsContent value="new">
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-6">
                        <Card className="bg-stone-900 text-white border-0 h-full">
                            <CardContent className="p-8 space-y-8">
                                <div>
                                    <h3 className="text-xl font-bold mb-6">We're here to help</h3>
                                    <div className="space-y-6">
                                        <div className="flex items-start gap-4">
                                            <Phone className="w-6 h-6 text-bright-red-500" />
                                            <div>
                                        ...
                                        <div className="flex items-start gap-4">
                                            <Mail className="w-6 h-6 text-bright-red-500" />
                                            <div>
                                        ...
                                        <div className="flex items-start gap-4">
                                            <MapPin className="w-6 h-6 text-bright-red-500" />
                                            <div>
                    ...
                    <Card>
                        <CardContent className="p-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <Button 
                                    type="submit" 
                                    className="w-full bg-bright-red-600 hover:bg-bright-red-700 h-12"
                            ...
                            {myTickets.length === 0 ? (
                                ...
                                myTickets.map(ticket => (
                                    <div 
                                        ...
                                        className={`p-3 rounded-lg cursor-pointer border transition-colors ${selectedTicket?.id === ticket.id ? 'bg-bright-red-50 border-bright-red-200' : 'hover:bg-stone-50'}`}
                                    >
                            ...
                            <>
                                    ...
                                    {selectedTicket.messages.map((msg, idx) => (
                                        <div key={idx} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                                            <div className={`max-w-[80%] rounded-2xl p-3 text-sm ${
                                                msg.sender === 'user' 
                                                ? 'bg-bright-red-600 text-white rounded-br-none' 
                                ...
                                <div className="p-3 border-t bg-stone-50 flex gap-2">
                                    <Input 
                                        ...
                                        className="bg-white"
                                    />
                                    <Button onClick={handleReply} className="bg-bright-red-600 hover:bg-bright-red-700 px-3">
