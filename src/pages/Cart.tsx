    ...
    <div className="min-h-screen bg-stone-50 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
              <Card className="sticky top-24 shadow-lg border-t-4 border-t-bright-red-600">
                  <CardContent className="p-6 space-y-4">
                      ...
                      <div className="border-t pt-4 mt-4">
                          ...
                          <Button className="w-full bg-bright-red-600 hover:bg-bright-red-700 h-12 text-lg" onClick={handleCheckout} disabled={isCheckingOut}>
