        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            <div className="flex items-center gap-2 mb-1">
                <Badge className="bg-bright-red-600">SUPER ADMIN</Badge>
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-lg font-bold truncate text-bright-red-600" title={stats.topProduct}>{stats.topProduct}</div>
                                ...
                                return (
                                    <div key={idx} className="flex flex-col items-center gap-2 w-full group">
                                        <div className="relative w-full bg-stone-100 rounded-t-md h-full flex items-end overflow-hidden">
                                            <div className="w-full bg-stone-900 group-hover:bg-bright-red-600 transition-all duration-500 rounded-t-md relative" style={{ height: `${height}%` }}>
